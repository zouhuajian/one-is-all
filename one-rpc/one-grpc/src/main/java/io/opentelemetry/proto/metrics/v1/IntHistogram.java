 ...
 * </pre>
 * <p>
 * Protobuf type {@code opentelemetry.proto.metrics.v1.IntHistogram}
 */
@Deprecated
public final class IntHistogram extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:opentelemetry.proto.metrics.v1.IntHistogram)
                ...
                switch (tag) {
                    ...
                    case 10: {
                        if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                            dataPoints_ = new java.util.ArrayList<IntHistogramDataPoint>();
                            mutable_bitField0_ |= 0x00000001;
                        }
                        dataPoints_.add(
                                input.readMessage(IntHistogramDataPoint.parser(), extensionRegistry));
                        break;
                    }
                    case 16: {
    ...
    getDescriptor() {
        return MetricsProto.internal_static_opentelemetry_proto_metrics_v1_IntHistogram_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return MetricsProto.internal_static_opentelemetry_proto_metrics_v1_IntHistogram_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        IntHistogram.class, Builder.class);
    }

    public static final int DATA_POINTS_FIELD_NUMBER = 1;
    private java.util.List<IntHistogramDataPoint> dataPoints_;

    /**
     * <code>repeated .opentelemetry.proto.metrics.v1.IntHistogramDataPoint data_points = 1;</code>
     */
    @Override
    public java.util.List<IntHistogramDataPoint> getDataPointsList() {
        return dataPoints_;
    }
     ...
     */
    @Override
    public java.util.List<? extends IntHistogramDataPointOrBuilder>
     ...
     */
    @Override
    public IntHistogramDataPoint getDataPoints(int index) {
     ...
     */
    @Override
    public IntHistogramDataPointOrBuilder getDataPointsOrBuilder(
            int index) {
        return dataPoints_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        IntHistogram other = (IntHistogram) obj;
    ...
    public static IntHistogram parseFrom(
    ...
    public static IntHistogram parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static IntHistogram parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static IntHistogram parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
                .parseDelimitedWithIOException(PARSER, input);
    }

    public static IntHistogram parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(IntHistogram prototype) {
    ...
    public static final class Builder extends
            ...
            // @@protoc_insertion_point(builder_implements:opentelemetry.proto.metrics.v1.IntHistogram)
            IntHistogramOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
            return MetricsProto.internal_static_opentelemetry_proto_metrics_v1_IntHistogram_descriptor;
        ...
        // Construct using io.opentelemetry.proto.metrics.v1.IntHistogram.newBuilder()
        private Builder() {
        ...
        public IntHistogram build() {
            IntHistogram result = buildPartial();
        ...
        public IntHistogram buildPartial() {
            IntHistogram result = new IntHistogram(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof IntHistogram) {
                return mergeFrom((IntHistogram) other);
            } else {
        ...
        public Builder mergeFrom(IntHistogram other) {
            if (other == IntHistogram.getDefaultInstance()) return this;
            if (dataPointsBuilder_ == null) {
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            IntHistogram parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (IntHistogram) e.getUnfinishedMessage();
        ...
        private void ensureDataPointsIsMutable() {
            if (!((bitField0_ & 0x00000001) != 0)) {
                dataPoints_ = new java.util.ArrayList<IntHistogramDataPoint>(dataPoints_);
                bitField0_ |= 0x00000001;
            }
        }

        private com.google.protobuf.RepeatedFieldBuilderV3<
                IntHistogramDataPoint, IntHistogramDataPoint.Builder, IntHistogramDataPointOrBuilder> dataPointsBuilder_;
        ...
        public Builder setDataPoints(
                int index, IntHistogramDataPoint value) {
            if (dataPointsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         */
        public Builder setDataPoints(
                int index, IntHistogramDataPoint.Builder builderForValue) {
            if (dataPointsBuilder_ == null) {
                ensureDataPointsIsMutable();
         ...
         * <code>repeated .opentelemetry.proto.metrics.v1.IntHistogramDataPoint data_points = 1;</code>
         */
        public Builder addDataPoints(IntHistogramDataPoint value) {
            if (dataPointsBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         */
        public Builder addDataPoints(
                IntHistogramDataPoint.Builder builderForValue) {
            if (dataPointsBuilder_ == null) {
                ensureDataPointsIsMutable();
        ...
        public Builder addAllDataPoints(
                Iterable<? extends IntHistogramDataPoint> values) {
            if (dataPointsBuilder_ == null) {
                ensureDataPointsIsMutable();
         ...
         * <code>repeated .opentelemetry.proto.metrics.v1.IntHistogramDataPoint data_points = 1;</code>
         */
        public IntHistogramDataPoint.Builder getDataPointsBuilder(
                int index) {
        ...
        public IntHistogramDataPoint.Builder addDataPointsBuilder() {
            return getDataPointsFieldBuilder().addBuilder(
                    IntHistogramDataPoint.getDefaultInstance());
        }
        ...
        public IntHistogramDataPoint.Builder addDataPointsBuilder(
                int index) {
            return getDataPointsFieldBuilder().addBuilder(
                    index, IntHistogramDataPoint.getDefaultInstance());
        }

        /**
         * <code>repeated .opentelemetry.proto.metrics.v1.IntHistogramDataPoint data_points = 1;</code>
         */
        public java.util.List<IntHistogramDataPoint.Builder>
        getDataPointsBuilderList() {
            return getDataPointsFieldBuilder().getBuilderList();
        }

        private com.google.protobuf.RepeatedFieldBuilderV3<
                IntHistogramDataPoint, IntHistogramDataPoint.Builder, IntHistogramDataPointOrBuilder>
        getDataPointsFieldBuilder() {
            if (dataPointsBuilder_ == null) {
        ...
        // @@protoc_insertion_point(builder_scope:opentelemetry.proto.metrics.v1.IntHistogram)
    }
