...
package org.coastline.one.flink.stream.functions.trigger;
 ...
 */
@PublicEvolving
public class ProcessingTimeoutPurgeTrigger<T, W extends Window> extends Trigger<T, W> {
    ...
    private ProcessingTimeoutPurgeTrigger(
    ...
    /**
     * Creates a new {@link ProcessingTimeoutPurgeTrigger} that fires when the inner trigger is fired or
     ...
     * @return {@link ProcessingTimeoutPurgeTrigger} with the above configuration.
     */
    public static <T, W extends Window> ProcessingTimeoutPurgeTrigger<T, W> of(
            Trigger<T, W> nestedTrigger, Duration timeout) {
        return new ProcessingTimeoutPurgeTrigger<>(nestedTrigger, timeout.toMillis(), false, true);
    }
    ...
    public static <T, W extends Window> ProcessingTimeoutPurgeTrigger<T, W> of(
            ...
            boolean resetTimerOnNewRecord,
            boolean shouldClearOnTimeout) {
        return new ProcessingTimeoutPurgeTrigger<>(
