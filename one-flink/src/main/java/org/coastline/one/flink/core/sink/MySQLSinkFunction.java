package org.coastline.one.flink.core.sink;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.pool.HikariPool;
import org.apache.flink.configuration.Configuration;
import org.apache.flink.streaming.api.functions.sink.RichSinkFunction;
import org.coastline.one.flink.core.util.ConfigurationTool;
...
public class MySQLSinkFunction<T> extends RichSinkFunction<T> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        props.setProperty("driverClassName", DRIVER_CLASS_NAME);
